...
export class AllInactiveDriverAssignmentsComponent implements OnInit {
  ...
  selectedAssignment: InactiveDriverAssignment | null = null;
  ...
  loadAssignments($event?: any): void {
    ...
    this.dataService
      .post<InactiveDriverAssignmentApiResponse>(
  ...
  viewAssignmentDetails(assignment: InactiveDriverAssignment): void {
  ...
  getFullName(assignment: InactiveDriverAssignment): string {
