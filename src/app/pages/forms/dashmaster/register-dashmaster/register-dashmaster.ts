...
@Component({
  selector: 'app-create-dashmaster',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './register-dashmaster.html',
  styleUrls: ['./register-dashmaster.css', '../../../../../styles/global/_toast.css'],
  providers: [MessageService]
})
export class RegisterDashmasterComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.dataService
      .post<ApiResponse>(API_ENDPOINTS.REGISTER_USER, payload, 'register-dashmaster-user')
      .subscribe({
        next: (response) => {
          console.log('Dashmaster created successfully', response);
          ...
          if (response.status == 0) {
            this.messageService.add({
              severity: 'success',
              summary: 'Success',
              detail: response.message || 'Dashmaster created successfully',
              life: 4000
            });
          } else {
            this.messageService.add({
