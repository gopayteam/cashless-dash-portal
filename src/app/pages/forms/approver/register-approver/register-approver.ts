...
@Component({
  ...
  templateUrl: './register-approver.html',
  styleUrls: ['./register-approver.css', '../../../../../styles/global/_toast.css'],
  providers: [MessageService]
})
export class RegisterApproverComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.dataService
      .post<ApiResponse>(API_ENDPOINTS.REGISTER_USER, payload, 'register-approver-user')
      .subscribe({
        next: (response) => {
          console.log('Approver created successfully', response);
          ...
          if (response.status == 0) {
            this.messageService.add({
              severity: 'success',
              summary: 'Success',
              detail: response.message || 'Approver created successfully',
              life: 4000
            });
          } else {
            this.messageService.add({
