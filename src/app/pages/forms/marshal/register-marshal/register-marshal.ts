...
@Component({
  ...
  templateUrl: './register-marshal.html',
  styleUrls: ['./register-marshal.css', '../../../../../styles/global/_toast.css'],
  providers: [MessageService]
})
export class RegisterMarshalComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.dataService
      .post<ApiResponse>(API_ENDPOINTS.REGISTER_USER, payload, 'register-marshal-user')
      .subscribe({
        next: (response) => {
          console.log('Marshal created successfully', response);
