...
@Component({
  ...
  templateUrl: './register-inspector.html',
  styleUrls: ['./register-inspector.css', '../../../../../styles/global/_toast.css'],
  providers: [MessageService]
})
export class RegisterInspectorComponent implements OnInit {
        ...
        next: (response) => {
          ...
          if (response.status == 0) {
            this.messageService.add({
              severity: 'success',
              summary: 'Success',
              detail: response.message || 'Inspector created successfully',
              life: 4000
            });
          } else {
            this.messageService.add({
