...
@Component({
  ...
  templateUrl: './register-conductor.html',
  styleUrls: ['./register-conductor.css', '../../../../../styles/global/_toast.css'],
...
export class RegisterConductorComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.dataService
      .post<ApiResponse>(API_ENDPOINTS.REGISTER_USER, payload, 'register-conductor-user')
      .subscribe({
        next: (response) => {
          console.log('Conductor created successfully', response);
          ...
          this.messageService.add({
            severity: 'success',
            summary: 'Success',
            detail: response.message || 'Conductor created successfully',
            life: 4000
          });
